...
public class NewsMenuDetailPager extends BaseMenuDetailPager {
	...
	public View initViews() {
		...
		tabPageIndicator.setOnPageChangeListener(new MyIndicatorListener());

		btnRightArrow.setOnClickListener(new MyBtnNextListener());
		return view;
	}
	 ...
	 * 
	 */
	private class MyIndicatorListener implements OnPageChangeListener {
	 ...
	 * 
	 */
	private class MyBtnNextListener implements OnClickListener {
